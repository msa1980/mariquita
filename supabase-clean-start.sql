-- =============================================
-- SCRIPT LIMPO - RECRIA TUDO DO ZERO
-- Execute este script no SQL Editor do Supabase
-- =============================================

-- Primeiro, vamos limpar tudo que pode existir
...
-- ORDER_ITEMS: Básico - permitir visualização
...
-- PAYMENTS: Básico - permitir visualização
